        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Bookshelf books={bookshelf1} sectionName="Currently Reading" />
                <Bookshelf books={bookshelf2} sectionName="Want To Read" />
                <Bookshelf books={bookshelf3} sectionName="Read" />
              </div>
            </div>
